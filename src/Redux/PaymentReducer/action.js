    ...
    const options = {
        ...
        handler: async (response) => {
            try {
                ...
                if (captured) {
                    axios.post("/api/email/send", { to, subject: `Badaa Basket`, message: `Thanks for Buying! your ordered ${orders} Items. Payment is successful Rs.${total} with Discount of Rs.${totalDiscount}` })
