            ...
            <div className="container mx-auto justify-content-center">
                <div className="row">
                    ...
                    <div className="col-3">
                        ...
                        <div className="row">
                            <div className="col circleFb m-2">
                                <i className="fa fa-facebook mt-2 pt-1 ml-1 h4" aria-hidden="true"></i>
                            </div>
                            <div className="col circleP m-2">
                                <i className="fa fa-pinterest-p mt-2 pt-1 ml-1 h4" aria-hidden="true"></i>
                            </div>
                            <div className="col circleT m-2">
                                <i className="fa fa-twitter mt-2 pt-1 ml-1 h4" aria-hidden="true"></i>
                            </div>
                            <div className="col circleI m-2">
                                <i className="fa fa-instagram mt-2 pt-1 ml-1 h4" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div className="row">
                            <img className="ml-5" src="https://seal.beyondsecurity.com/verification-images/www.bigbasket.com/vulnerability-scanner-2.gif" alt="security" />
                        </div>
                    </div>
                </div>
                <hr />
