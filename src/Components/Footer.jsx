                            ...
                            <div className="row">
                                <div className="col-3">
                                    <div className="circleFb">
                                        <i className="fa fa-facebook ml-3 mt-3 h4" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div className="col-3">
                                    <div className="circleP">
                                        <i className="fa fa-pinterest-p ml-3 mt-3 h4" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div className="col-3">
                                    <div className="circleT">
                                        <i className="fa fa-twitter ml-3 mt-3 h4" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div className="col-3">
                                    <div className="circleI">
                                        <i className="fa fa-instagram ml-3 mt-3 h4" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
                            <div>
