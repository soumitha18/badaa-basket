<img src="http://badaabasket.tk/bb.png" alt="bb" />
...
<b style="color:red;">Badaa Basket is Cloning of Big Basket.</b> Badaa Basket is an e-commerce platform for groceries. As we open our website we can login or signup with personal details or Google or Facebook authentication. Set your near by Badaa Basket location. You can serach the products or filter it by category and can make customizations. In product page details We can see the about product, actual price, discount price, saving from choosing product, rating and reviews by customers, quantity requried etc. We can add the products to the Basket there we can edit the quantity requried, remove the product, overall view of products purchased and amount payable. We can edit profile, deivery address. From choosing products from our vast varieties click on checkout option where order summary is displayed by clicking payment option it will redirect to bank servers after successfull payment, can track the order details. If any queries and support regarding the products one can access the customer support panel.
